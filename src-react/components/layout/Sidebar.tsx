...
export function Sidebar() {
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <aside
        className={cn(
          'relative flex h-screen flex-col border-r border-border/50 bg-card sticky top-0 overflow-hidden',
          ...
          {navItems.map((item) => {
            ...
            const buttonContent = (
              <Button
                variant="ghost"
                className={cn(
                  'relative w-full rounded-xl border border-transparent text-left transition-colors duration-200',
                  isSidebarCollapsed 
