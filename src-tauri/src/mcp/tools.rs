...
pub struct CabMcpServer {
    ...
    // Populated + consumed by the #[tool_router]/#[tool_handler] macros; the
    // field itself is not read directly, hence the allow.
    #[allow(dead_code)]
...
impl ServerHandler for CabMcpServer {
    fn get_info(&self) -> ServerInfo {
        ...
        implementation.name = "community-agent-bridge".into();
