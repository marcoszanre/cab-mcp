...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .manage(coding_agent::CodingAgentState::new())
        .invoke_handler(tauri::generate_handler![
            ...
            // Coding agent (Copilot CLI) commands
            coding_agent::coding_agent_check,
            coding_agent::coding_agent_list_models,
            coding_agent::coding_agent_start_session,
            coding_agent::coding_agent_send,
            coding_agent::coding_agent_end_session,
            // Secure store (OS-protected credential storage)
